...
Linus Torvalds
![](https://i.imgur.com/kFqvmNv.png)

Algunas distribuciones GNU/Linux: 
![](https://i.imgur.com/z2WoMBn.png)
...
Llaves de control más últiles:
* Ctrl + c para deterner el comando en curso.
* Ctrl + d para cerrar la terminal en turno.
* Ctrl + f como alternativa para desplazarnos a la derecha de la línea.
* Ctrl + b para desplazarnos a la izquierda de la línea. 
* Ctrl + r para buscar a través del historial de comandos.
* Ctrl + shiff + t para abrir nueva pestaña de terminal.
...
Ahora vamos a darle ordenes a la terminal:
Primero, ¿Cómo saber que shell estoy usando?
¡Recuerden no teclear el **$**!
...
* Las **opciones/flags** son un tipo especial de argumento que le indica al comando que tipo de acción realizar, es decir, cambia el funcionamiento original del comando.
En general, las opciones se definen después de:
...
**Tipos de archivos:**
* **Archivos regulares:** También llamados archivos de texto,  estos contienen caracteres que pueden ser leídos.
* **Archivos ejecutables:** Programas, estos invocan comandos. Algunos no pueden ser leídos por humanos.
* **Directorios:** Carpetas que contiene otros archivos, probablemente otros directorios (subdirectorios).
...
$ cd proyecto
```
Si ingresan el comando **pwd** podrán ver que ahora su posición ha cambiado. 
Ahora creen en "proyecto" un directorio llamado **genoma**, y se regresan a su home/usuario
...
**wget:** Se usa para descargar archivos del internet via TTP, HTTPS, FTP, o FTPS.
**wget [OPTIONS]... [ URLS ]**
...
```
Los que quieran saber más sobre el rendiemiento de ambas:
...
**-v:** verbose, muestra una salida.
**-z:** compresión con gzip.
**-j:** compresión con bzip2.
**-f:** selecciona el archivo que queremos comprimir y siempre debe de ir al final de las opciones.
**-x:** extrae documentos de un archivo tar.
...
**Nota:**
Podemos extraer múltiples columnas haciendo **cut** -f 1,4,8 archivo

**grep:** Este comando nos permite buscar una palabra o un patrón que definamos dentro de un archivo de texto.
Por ejemplo, si quisieramos buscar este identificador TRINITY_DN32673_c0_g1 en nuestro archivo de anotación.
...
/LUSTRE/bioinformatica_data/curso2022


  Recordando que deben trabajar en la zona de lustre y no en sus directorios personales para lo cual deben utilizar:
cd curso2022
Esta instrucción posicionará a cada estudiante en la trayectoria de su respectivo subdirectorio:
/LUSTRE/bioinformatica_data/curso2022/accounts/cursoNN
...
![](https://i.imgur.com/urh6Yjf.png)
![](https://i.imgur.com/LDs4mtA.png)
![](https://i.imgur.com/wdlnC9y.png)
...
Acá les dejo otros editores más amigables:
**Sublime Text**:

Link: https://www.sublimetext.com/
![](https://i.imgur.com/OLAr31n.jpg)
...
**squeue:** Sirve para revisar los trabajos que están siendo procesados o que se encuentran en la cola de tareas.
**scancel [jobID]:** Sirve para cancelar una tarea.
**top:** Sirve para visualizar los procesos que se están ejecutando.
...
* Extraigan específicamente las columnas correspondientes a la longitud y producto, ordenen estos resultados, sustituyan hypothetical protein por NA, reporten únicamente longitudes únicas y guarden este resultado en un nuevo archivo.
(reportar la línea de comando usada)
...
1.- Descomprima el archivo, genere un **alias** con el nombre: **contar_fasta** que les permita contar el número de secuencias en el archivo.
* Reportar línea con asignación de alias y comando empleado.
* ¿Cuantas secuencias se encontraban en el archivo fasta?
