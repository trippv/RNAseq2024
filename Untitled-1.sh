...
INPUT_DIR="/home/mtripp/CURSO_RNASEQ2024/fastqc_test/secuencias"  # Cambia esta ruta a donde estén tus archivos de entrada
OUTPUT_DIR="/home/mtripp/CURSO_RNASEQ2024/fastqc_test/trimmed"  # Cambia esta ruta a donde quieras guardar los archivos procesados
...
for INPUT_R1 in ${INPUT_DIR}/*_1.fastq.gz
do
    # Define el archivo correspondiente de lectura inversa (R2)
    SAMPLE_BASE=$(basename $INPUT_R1 "_1.fastq.gz")
    INPUT_R2=${INPUT_DIR}/${SAMPLE_BASE}_2.fastq.gz
